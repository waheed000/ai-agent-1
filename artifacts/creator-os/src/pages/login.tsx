      ...
      <div className="hidden lg:flex flex-col justify-center p-12 bg-secondary/50 border-r border-border relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md mx-auto">
          ...
          <div className="p-6 rounded-xl border border-border bg-card/80 backdrop-blur-sm shadow-xl">
            ...
            <p className="text-sm italic text-muted-foreground">"I've found a new pattern in your YouTube retention graph. Your hooks are losing 15% fewer viewers than last week."</p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center space-x-2">
              <input type="checkbox" id="remember" className="rounded border-border bg-secondary text-primary focus:ring-primary h-4 w-4" />
            ...
            <Button type="button" variant="outline" className="w-full h-11 bg-card hover:bg-secondary">
