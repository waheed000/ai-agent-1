...
describe('PlannerRepository', () => {
  ...
  it('creates a content plan item', async () => {
    const { default: repo } = await import('../repositories/PlannerRepository.js');
...
describe('DraftRepository', () => {
  ...
  it('creates a draft', async () => {
    const { default: repo } = await import('../repositories/DraftRepository.js');
...
describe('PlannerService', () => {
  ...
  it('generate creates the correct number of items', async () => {
    const { default: service } = await import('../services/PlannerService.js');
  ...
  it('deleteDraft soft-deletes the draft', async () => {
    ...
    const { default: DraftRepository } = await import('../repositories/DraftRepository.js');
...
describe('CalendarService', () => {
  ...
  it('getCalendar returns a day array covering the range', async () => {
    const { default: service } = await import('../services/CalendarService.js');
  ...
  it('getCalendar groups items by date', async () => {
    const { default: calService } = await import('../services/CalendarService.js');
    const { default: planService } = await import('../services/PlannerService.js');
...
describe('ContentWorkflow', () => {
  ...
  it('advance moves draft → review', async () => {
    const { default: workflow } = await import('../services/ContentWorkflow.js');
    const { default: planRepo } = await import('../repositories/PlannerRepository.js');
  ...
  it('transitions map covers all status values', async () => {
    const { ContentWorkflowTransitions } = await import('../services/PublishingService.js');
...
describe('PublishingService', () => {
  ...
  it('publishDraft updates draft status to published', async () => {
    const { default: service } = await import('../services/PublishingService.js');
    const { default: draftRepo } = await import('../repositories/DraftRepository.js');
