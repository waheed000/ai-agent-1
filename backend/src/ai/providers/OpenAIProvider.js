 ...
 *
 * API key and model are read from config (which reads OPENAI_API_KEY / OPENAI_MODEL).
...
export class OpenAIProvider extends AIProvider {
  constructor(model = config.ai.openai.model) {
    super();
    this._model  = model;
    this._apiKey = config.ai.openai.apiKey || null;
  }
